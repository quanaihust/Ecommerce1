        ...
        <div class="container">
            <section class="rw-wrapper">
                <h1 class="rw-sentence">
                    ...
                    <div clas="rw-words rw-words-2">
                        <span>Cute, Safe and Fashionable</span>
                        <span>Gentle</span>
                        <span>Cute, Safe and Fashionabl
                        <span>Beauty</span>e</span>
                        <span>Gentle</span>
                        <span>Beauty</span>
                    </div>
                </h1>
            ...
            <div class="content-top">
                <div class="col-md-6 col-md">
                    ...
                    <div class="col-2">
                        ...
                        <p style="font-family: Ubuntu;">Các trang ph?c bán ch?y nh?t, ??p nh?t, th?i trang và phong cách nh?t!!!</p>
                        <a href="#" class="buy-now">Buy Now</a>
                    </div>
                </div>
                <div class="col-md-6 col-md1">
                    <div class="col-3">
                        <a href="#"><img src="images/men.jpg" class="img-responsive" alt="">
                            <div class="col-pic">
                                <p>Fashion</p>
                                <label></label>
                                <h5>For Men</h5>
                    ...
                    <div class="col-3">
                        <a href="#"><img src="images/kids.jpg" class="img-responsive" alt="">
                            <div class="col-pic">
                                <p>Fashion</p>
                                <label></label>
                                <h5>For Kids</h5>
                    ...
                    <div class="col-3">
                        <a href="single.jsp"><img src="images/women.jpg" class="img-responsive" alt="">
                            <div class="col-pic">
                                <p>Fashion</p>
                                <label></label>
                                <h5>For Women</h5>
